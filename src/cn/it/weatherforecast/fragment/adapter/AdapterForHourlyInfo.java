...
public class AdapterForHourlyInfo extends BaseAdapter {
	...
	public AdapterForHourlyInfo(List<AdapterHourlyInfoModel> data,
			Context context) {
		mHourlyInfo = data;
		mContext = context;
	}
	...
	public View getView(int position, View convertView, ViewGroup container) {
		...
		if (convertView == null) {
			...
			viewHolder.hourly_date = (TextView) view
					.findViewById(R.id.hourly_date);
			viewHolder.hourly_pop = (TextView) view
					.findViewById(R.id.hourly_persent);
			viewHolder.hourly_dir = (TextView) view
					.findViewById(R.id.hourly_flow);
			viewHolder.hourly_tmp = (TextView) view
					.findViewById(R.id.hourly_temperature);
