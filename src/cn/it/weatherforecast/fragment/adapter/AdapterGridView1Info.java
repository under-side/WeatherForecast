...
public class AdapterGridView1Info extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup container) {
	    ...
	    if(convertView==null)
	    {
	    	...
	    	viewHolder.text1=(TextView) view.findViewById(R.id.gird1_text1_text);
	    	viewHolder.text1_detail=(TextView) view.findViewById(R.id.grid1_text1_detail);
	    	viewHolder.text2=(TextView) view.findViewById(R.id.grid1_text2_text);
	    	viewHolder.text2_detail=(TextView) view.findViewById(R.id.grid1_text2_detail);
